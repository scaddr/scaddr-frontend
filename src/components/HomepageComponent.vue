...
<template>
  <div :class="[wallpaperDefaultClasses, verticallyCenterClasses]">
    <div class="text-white text-center bg-black bg-opacity-95 rounded-lg w-fit px-32 py-10 hover:bg-opacity-100 transition shadow-black shadow-xl box-border">
      ...
      <button @click="createPrivateRoom" class="w-full cursor-pointer border border-white px-3 py-2.5 rounded-[7px] text-black bg-white text-sm opacity-75 hover:opacity-100 transition">Create private room</button>
    </div>
  </div>
</template>
